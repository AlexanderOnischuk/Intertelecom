...
Intertelecom.bat - Скрипт автоматичного підключення інтернету для постійного зв'язку, наприклад необхідно програмі NiceHash для добування монет біткоїну (майнінгу).
