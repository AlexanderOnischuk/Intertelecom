...
Intertelecom.bat - Скрипт автоматичного підключення інтернету для постійного зв'язку, наприклад необхідно програмі NiceHash чи іншого майнера для добування монет біткоїну (майнінгу).
...
Цей скрипт можна вставити в Автозагрузку Windows і якщо модем постійно підключений, система автоматично підключатиметься до інтернету після включення ПК, збоїв модему/вишки.
